  ...
  <div className="mx-auto max-w-screen-xl px-4 md:px-8">
    ...
    <div className="grid gap-y-10 sm:grid-cols-2 sm:gap-y-12 lg:grid-cols-3 lg:divide-x">
      ...
      <div className="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
        <div className="text-center text-gray-600">“Empowering futures through digital literacy, one keystroke at a time.”</div>
        ...
        <div className="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
          ...
          <div>
            <div className="text-center text-sm font-bold text-indigo-500 sm:text-left md:text-base">Chandra Naik</div>
            <p className="text-center text-sm text-gray-500 sm:text-left md:text-sm">CEO </p>
          </div>
        </div>
      </div>
 
      <div className="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
        <div className="text-center text-gray-600">“Unlocking the potential of every learner in the world of technology.”</div>
        ...
        <div className="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
          ...
          <div>
            <div className="text-center text-sm font-bold text-indigo-500 sm:text-left md:text-base">Mithun</div>
            <p className="text-center text-sm text-gray-500 sm:text-left md:text-sm">Stduent </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center gap-4 sm:px-4 md:gap-6 lg:px-8">
        <div className="text-center text-gray-600">“Igniting curiosity, fueling innovation in the digital age.”</div>
        ...
        <div className="flex flex-col items-center gap-2 sm:flex-row md:gap-3">
          ...
          <div>
            <div className="text-center text-sm font-bold text-indigo-500 sm:text-left md:text-base">Amrutha</div>
            <p className="text-center text-sm text-gray-500 sm:text-left md:text-sm">Student </p>
          </div>
        </div>
      </div>
